...
/**
   * Instantiate a GPS
   * @param {object} io - A complete serial IO options object
   * @param {(number[]|string[])} [io.pins] - An array of two pin identifiers, Send and Receive
   * @param {(string|constructor)} [io.io=builtin/serial] - If passing an object, a string specifying a path to the IO provider or a constructor
   * @param {number} [io.baud] - Desired baud rate
