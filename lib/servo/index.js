...
class Servo extends Emitter {
   ...
   * @param {(string|constructor)} [io.io=builtin/pwm] - If passing an object, a string specifying a path to the IO provider or a constructor
   * @param {object} device - An optional object containing device specific settings
