 ...
 * @description A module for controlling electric motors by using PWM (Pulse Width Modulation) and digital pins to regulate the speed and direction of the motor. While it is possible to wire a (tiny) motor directly to your microcontroller, it is best to use a motor controller, which allows for higher voltages and current.
 * @module j5e/motor
 * @requires module:j5e/event
 * @requires module:j5e/fn
 * @linnk https://en.wikipedia.org/wiki/Electric_motor
 * @link https://en.wikipedia.org/wiki/Motor_controller
...
class Motor extends Emitter {
  ...
  /**
   * Instantiate a Motor
   * @param {number|string|number[]|string[]|object[]|object} io - A pin identifier or motor IO options object (See {@link https://j5e.dev/core-concepts/instantiation/|instantiation})
   * @example
   * // Using a pin number
