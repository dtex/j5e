/**
 * Class library for managing LED's (Light Emitting Diodes). They can be connected to a digital IO (On/Off), or to a PWM IO (varying brightness).
 * @module j5e/led
...
class LED {
  ...
  /**
   * Instantiate an LED
   * @param {object} io - Pin identifier or IO Options (See {@tutorial C-INSTANTIATING})
   * @param {boolean} [io.pwm=false] - True if the device is wired to a PWM pin
