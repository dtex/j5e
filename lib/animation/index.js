...
class Animation extends Emitter {
   ...
   * Animation
   * @constructor
   * @param {Object|Object[]} target - Device (LED, RGB, or Servo) or an array of devices to be animated (See {@link /core-concepts/instantiation/|instantiation} for more information)
   * @example
   * // Make a servo "wave"
