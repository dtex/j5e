 ...
 * @module j5e/gps
 * @description A module that allows communication with a GPS receiver. The default receiver is any that will send NMEA 0183 sentences over serial as soon as it is powered on.
 * @requires module:j5e/event
 * @requires module:j5e/fn
 * @link https://en.wikipedia.org/wiki/Satellite_navigation_device
 * @link https://en.wikipedia.org/wiki/Global_Positioning_System
 * @link https://en.wikipedia.org/wiki/NMEA_0183
 * @link https://en.wikipedia.org/wiki/Serial_communication
 */
 ...
 * @classdesc The GPS class allows communication with any GPS receiver that will send NMEA 0183 sentences over serial as soon as it is powered on
 * @extends Emitter
 * @fires GPS#sentence
