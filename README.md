Control LED's, Servos, Switches, and more with j5e. It runs directly onboard microcontrollers like the ESP8266. Your code is 100% JavaScript. It does not require node.js, a host server or an SBC to host the app.
...
*TC-53's emerging standard is still in flux so understand there is some risk of changes in the future*
